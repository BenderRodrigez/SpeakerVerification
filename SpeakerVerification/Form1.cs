    ...
    public partial class Form1 : Form
    {
        ...
        private void trainDataSelectButton_Click(object sender, EventArgs e)
        {
            if (wavFileOpenDialog.ShowDialog(this) == DialogResult.OK)
            {
                ...
                tonalSpeechSelector.InitData(speechFile, (float) analysisIntervalUpDown.Value,
        ...
        private double[][] GetAcfImage(float[] speechFile, WaveFormat speechFileFormat, Tuple<int,int>[] speechMarks)
        {
            ...
            return trainDataAcf.Select(x => new[] {x[0]>0.0?speechFileFormat.SampleRate/x[0]:0.0}).ToArray();
        }
